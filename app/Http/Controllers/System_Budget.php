    ...
    public function budgetAdmin(Request $request)
    {
        ...
        if(empty($exist[0]))
        {
          ...
          for ($i=1; $i < 3; $i++) {
              ...
              ['division' => 1,'area' => 1, 'location' => $id, 'revenue' => $output['area_west_revenue_'.$i], 'cost' => $output['area_west_cost_'.$i], 'profit' => $output['area_west_profit_'.$i], 'profit_rate' => $output['area_west_profitRate_'.$i], 'setting_rate' => $output['area_west_settingRate_'.$i], 'updated_at' => new DateTime]);
          }
          ...
          for ($i=1; $i < 3; $i++) {
              ...
              ->update(
              ['division' => 1,'area' => 2, 'location' => $id, 'revenue' => $output['area_central_revenue_'.$i], 'cost' => $output['area_central_cost_'.$i], 'profit' => $output['area_central_profit_'.$i], 'profit_rate' => $output['area_central_profitRate_'.$i], 'setting_rate' => $output['area_central_settingRate_'.$i], 'updated_at' => new DateTime]);
          }
          ...
          for ($i=1; $i < 3; $i++) {
              ...
              ['division' => 1,'area' => 3, 'location' => $id,'revenue' => $output['area_east_revenue_'.$i], 'cost' => $output['area_east_cost_'.$i], 'profit' => $output['area_east_profit_'.$i], 'profit_rate' => $output['area_east_profitRate_'.$i], 'setting_rate' => $output['area_east_settingRate_'.$i], 'updated_at' => new DateTime]
              );
          }
          echo "updated";
        }
